  ...
  <div class="pb-6">
    ...
    <div class="relative bg-white dark:bg-gray-900">
      ...
      <div class="relative overflow-hidden">
        <NuxtImg
          src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fimage_1.png?alt=media&token=1b87c221-01cd-4b24-a4a2-0f2f22288c10"
          alt="Baca PR" class="w-full" width="768" height="400"/>
      </div>
    </div>
          ...
          <div class="mt-4">
            ...
            <div v-if="item.id === 2" class="relative min-h-125">
              ...
              <div class="absolute left-0 top-0 w-36">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Fxfz_full.png?alt=media&token=a3ecb219-8552-4f51-acc0-9c4688c48a93"
                  alt="Xiao Fang Zi" class="w-full object-contain" width="144" height="200" />
              ...
              <div class="absolute right-8 top-0 w-16">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Fcounter.png?alt=media&token=b5437729-203e-4107-a12a-b06cd45a9c1f"
                  alt="Counter" class="w-full object-contain" width="64" height="80" />
              ...
              <div class="absolute right-4 top-24 w-24">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Fkain.png?alt=media&token=77715de1-05ab-4e7a-ab7e-90e8df7461bf"
                  alt="Kain Merah" class="w-full object-contain" width="96" height="120" />
              ...
              <div class="absolute left-10 top-[48%] w-28">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Fpen_full.png?alt=media&token=2bf2ef24-256a-4921-a2a1-223b7237394e"
                  alt="Pena Merah" class="w-full object-contain" width="112" height="140" />
              ...
              <div class="absolute right-8 top-[50%] w-24">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Fblack_pen.png?alt=media&token=596786cf-9bd4-4ad2-af2f-52e5093a82a9"
                  alt="Pena Hitam" class="w-full object-contain" width="96" height="120" />
              ...
              <div class="absolute left-4 top-[76%] w-24">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Famplop.png?alt=media&token=c1698c89-0335-483b-ae36-28825a315908"
                  alt="Amplop" class="w-full object-contain" width="96" height="120" />
              ...
              <div class="absolute right-4 top-[80%] w-24">
                <NuxtImg
                  src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fxfz%2Fbook.png?alt=media&token=c0b11515-be28-4df3-8f11-0edd6bc21222"
                  alt="Buku Paritta" class="w-full object-contain" width="96" height="120" />
            ...
            <div v-else-if="item.images.length === 1">
              <NuxtImg :src="item.images[0]" :alt="item.title"
                :class="['w-full rounded-lg object-contain', item.height]" width="600" height="400" />
            </div>
            ...
            <div v-else-if="item.images.length === 2" class="grid grid-cols-2 gap-4 items-end">
              <NuxtImg v-for="(img, idx) in item.images" :key="idx" :src="img" :alt="item.title"
                class="w-full rounded-lg object-contain max-h-72" width="300" height="288" />
            </div>
            <!-- More than 2 images: grid -->
            <div v-else class="grid grid-cols-2 gap-2 items-end">
              <NuxtImg v-for="(img, idx) in item.images" :key="idx" :src="img" :alt="item.title"
                :class="['w-full rounded-lg object-contain', item.height]" width="300" height="200" />
            </div>
          </div>
        </div>
      </UCarousel>
      ...
      <template #content>
        <div class="p-6 bg-white dark:bg-gray-800">
          ...
          <NuxtImg :src="selectedPerlengkapan?.image" :alt="selectedPerlengkapan?.title"
            class="w-32 h-32 object-contain mx-auto mb-4" width="128" height="128" />
    ...
    <div class="relative bg-[#ffefce] dark:bg-gray-800">
      ...
      <div class="relative overflow-hidden">
        <NuxtImg
          src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2FWhatsApp%20Image%202026-04-15%20at%2014.41.46.jpeg?alt=media&token=1c2c293b-3678-44a9-b2dd-08aa831e127b"
          alt="Tata Cara Sembahyang" class="w-full" width="768" height="400" />
      </div>
    </div>
    ...
    <div class="relative bg-white dark:bg-gray-900">
      ...
      <div class="relative overflow-hidden">
        <NuxtImg
          src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Faltarbesar%2Fimage_1.png?alt=media&token=4c54233e-4de3-4982-ba38-cd3f80e78b97"
          alt="Altar Besar" class="w-full" width="768" height="400" />
      </div>
    </div>
    ...
    <div class="relative bg-[#ffefce] dark:bg-gray-800">
      ...
      <div class="relative overflow-hidden">
        <NuxtImg
          src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Faltarkecil%2Faltar_kecil.png?alt=media&token=339fefa9-d2be-4124-9d98-98cca6501f41"
          alt="Altar Kecil" class="w-full" width="768" height="400" />
      </div>
    </div>
    ...
    <div class="relative bg-white dark:bg-gray-900">
      ...
      <div class="relative overflow-hidden">
        <NuxtImg
          src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2Fbimbingansp.jpeg?alt=media&token=80a558f8-43b3-440e-ac37-2bb0c898424e"
          alt="Permohonan Bimbingan Spiritual" class="w-full" width="768" height="400" />
      </div>
    </div>
    ...
    <div class="relative bg-[#ffefce] dark:bg-gray-800">
      ...
      <div class="relative overflow-hidden">
        <NuxtImg
          src="https://firebasestorage.googleapis.com/v0/b/master-lu-indonesia.appspot.com/o/images%2FWhatsApp%20Image%202026-04-15%20at%2014.41.34.jpeg?alt=media&token=fbba3e42-b482-460a-8ff3-dc5deed2a82d"
          alt="Permohonan Penggantian Nama" class="w-full" width="768" height="400" />
      </div>
    </div>
  </div>
</template>
