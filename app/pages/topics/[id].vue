          ...
          <div v-for="category in categories" :key="category.id" class="mb-2">
            ...
            <div v-if="(!searchModes[category.id] || !categorySearchResults[category.id]?.length) && category.sub_category.length > 0"
              ...
              <NuxtLink v-for="sub in category.sub_category" :key="sub.id"
                ...
                class="py-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-100 dark:active:bg-gray-700 block transition-colors active:scale-[0.98] transition-transform relative group touch-manipulation"
