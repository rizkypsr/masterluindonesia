<template>
  <div class="min-h-screen bg-white">
    ...
    <div class="flex items-center justify-between px-4 py-3 border-b">
      ...
      <span class="text-sm text-gray-600">5. Pertobatan Agung</span>
    ...
    <!-- Content -->
    <div class="px-4 py-6">
      <h1 class="text-2xl font-bold text-gray-900 mb-4">Pertobatan Agung</h1>

      <p class="text-gray-500 text-sm italic mb-4">Pertobatan Agung</p>
      ...
      <div class="mb-6">
        <h2 class="text-lg font-bold text-gray-900 mb-3">Pertobatan Agung</h2>
      ...
      <!-- Section: Manfaat -->
      <div class="mb-6">
        <h2 class="text-lg font-bold text-gray-900 mb-3">Manfaat Pertobatan Agung</h2>
      ...
      <div class="bg-yellow-50 rounded-lg p-4 mb-6">
        <h2 class="text-lg font-bold text-gray-900 mb-3">Cara Membaca Pertobatan Agung</h2>
      ...
      <!-- Section: Catatan -->
      <div class="mb-6">
        <h2 class="text-lg font-bold text-gray-900 mb-3">Catatan Penting</h2>
